# Markdown Notation Elements

## I want Markdown (not HTML)

Click on the "show markdown" link to see the markdown used to compose the elements on this page. Better still, copy the entire markdown page and paste for easy reference in the future. 


## BlockQuote and Headers Howto
...
You can use ***double square brackets*** to link to ***internal*** gollum or github wiki pages.
